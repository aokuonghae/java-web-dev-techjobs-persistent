...
public class HomeController {
    ...
    public String processAddJobForm(@ModelAttribute @Valid Job newJob, Errors errors, Model model,
                                    @RequestParam(value="employerId") int employerId, @RequestParam(value="skills") List<Integer> skills) {
//JobId=get the employer id. can't get the employer id to match to the job! and skill id//
        if (errors.hasErrors()) {
            model.addAttribute("title", "Add Job");
            return "add";
        }
